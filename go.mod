...
require (
	...
	github.com/nitrictech/nitric v0.20.0-rc.7
...
require github.com/seaweedfs/seaweedfs v0.0.0-20221121050500-26d9b662b1b3
...
require (
	...
	github.com/ydb-platform/ydb-go-sdk/v3 v3.39.0 // indirect
