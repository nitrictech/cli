...
INSERT INTO test_table (
    ...
    big_number, real_number, double_number, ip, mac, bit_field, char_field, interval_field, bytea_field
) VALUES 
    (
        ...
        '192.168.1.1', '08:00:2b:01:02:03', B'10101010', 'ABCDEFGHIJ', '1 year', '\\xDEADBEEF'
    ),
    (
        ...
        '10.0.0.1', '08:00:2b:04:05:06', B'11110000', 'KLMNOPQRST', '2 months', '\\xC0FFEE'
    ),
    (
        ...
        '172.16.0.1', '08:00:2b:07:08:09', B'00001111', 'UVWXYZABCD', '3 days', '\\xBAADF00D'
    ),
    (
        ...
        '192.168.100.1', '08:00:2b:10:11:12', B'11001100', 'EFGHIJKLMN', '4 hours', '\\xFEEDFACE'
    );
`
