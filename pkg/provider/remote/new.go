...
const providerRegex = `[a-z]+\/[a-z]+@(0|[1-9]\d*)\.(0|[1-9]\d*)\.(0|[1-9]\d*)(?:-((?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*)(?:\.(?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*))*))?(?:\+([0-9a-zA-Z-]+(?:\.[0-9a-zA-Z-]+)*))?`
...
func New(cfc types.ConfigFromCode, name, stack string, envMap map[string]string, opts *types.ProviderOpts) (types.Provider, error) {
	// Read the stack file
